...
def save():
    ...
    f=open("C:\Users\Windows 10\OneDrive\Desktop\Python Class\PRO-C118-Project-Boilerplate-main\static\assets\datafiles\updated_product_dataset.csv","a")
    # Log the data in the file
    f.write(data_entry+"\in")
